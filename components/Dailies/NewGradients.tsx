  ...
  return (
    <>
      ...
      <div className="relative h-20 w-58 rounded-full bg-neutral-800 flex justify-center items-center overflow-hidden">
        ...
        <div className="absolute h-[99%] w-[99%] rounded-full bg-neutral-800 flex justify-center items-center overflow-hidden"></div>
        <span className="absolute text-lg font-medium tracking-tight z-10 bg-linear-to-r from-transparent from-35% via-white via-50% to-transparent to-65% bg-clip-text text-white/40 animate-shimmer bg-[length:300%_100%]">
          tailwindcss 4.0
